...
pubspec_data_path="$root_project_package_path/data/pubspec.yaml"
pubspec_domain_path="$root_project_package_path/domain/pubspec.yaml"
pubspec_shared_path="$root_project_package_path/shared/pubspec.yaml"
pubspec_initializer_path="$root_project_package_path/initializer/pubspec.yaml"
pubspec_resources_path="$root_project_package_path/resources/pubspec.yaml"
pubspec_nals_lints_path="$root_project_package_path/nals_lints/pubspec.yaml"
